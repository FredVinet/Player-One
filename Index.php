                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ContactModal"><i class="fa-solid fa-comment me-2"></i></i>Contact Us</a></li>
                        </ul>
                    </div>
                    <?php require_once "./PHP/Home/modalContact.php"?>
